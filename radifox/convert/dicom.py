...
DCM_HEADER_ATTRS = [
    ...
    ("CTDIvol", "CTDIvol"),  # CT dose index (mGy)
    ("SpiralPitchFactor", "SpiralPitchFactor"),  # Helical pitch ratio
    ("SingleCollimationWidth", "SingleCollimationWidth"),  # Single detector row width in mm
    ("TotalCollimationWidth", "TotalCollimationWidth"),  # Total collimation width in mm
    ("DataCollectionDiameter", "DataCollectionDiameter"),  # Scan FOV diameter in mm
    ("ReconstructionDiameter", "ReconstructionDiameter"),  # Reconstruction FOV diameter in mm
    ("GantryDetectorTilt", "GantryDetectorTilt"),  # Gantry tilt angle in degrees
]
