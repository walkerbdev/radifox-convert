...
class BaseInfo:
    ...
    CT_ONLY_ATTRS = {
        "ConvolutionKernel", "KVP", "XRayTubeCurrent", "ExposureTime", "CTDIvol",
        "SpiralPitchFactor", "SingleCollimationWidth", "TotalCollimationWidth",
        "DataCollectionDiameter", "ReconstructionDiameter", "GantryDetectorTilt",
    }
    def __init__(self, path: Path) -> None:
        ...
        self.CTDIvol = None  # CT dose index (mGy)
        self.SpiralPitchFactor = None  # Helical pitch ratio
        self.SingleCollimationWidth = None  # Single detector row width in mm
        self.TotalCollimationWidth = None  # Total collimation width in mm
        self.DataCollectionDiameter = None  # Scan FOV diameter in mm
        self.ReconstructionDiameter = None  # Reconstruction FOV diameter in mm
        self.GantryDetectorTilt = None  # Gantry tilt angle in degrees
